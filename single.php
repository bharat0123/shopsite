	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			if(isset($_GET["prod_name"]))
			{
				...
				$a="select * from product where prod_name='$prod_name'";
				$b=mysqli_query($con,$a);
				$c=mysqli_fetch_array($b);
			}
			?>
				<h5><?php echo $c["prod_name"];?></h5>
				<div class="col-md-4 agileinfo_single_left">
		<?php echo "<img id='example' src=admin/product_upload/$c[image] alt='' class='img-responsive' />"?>
				</div>
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4><?php echo $c["price"]?> <span>$25.00</span></h4>
						</div>
